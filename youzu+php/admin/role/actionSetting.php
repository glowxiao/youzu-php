...
$sql_r = "SELECT * FROM r_action WHERE role_id={$rid}";
$re_r = mysqli_query($mysql, $sql_r);
$action_id_arr = array();
while ($data = mysqli_fetch_assoc($re_r)){
    $action_id_arr[] = $data['action_id'];
}
?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if(in_array($v['aid'], $action_id_arr)){?>
                                                                <a class="btn btn-danger btn-xs" href="actionAction.php?action=del&rid=<?php echo $rid;?>&aid=<?php echo $v['aid'];?>">设为不可用</a>
                                                            <?php }else{?>
                                                                <a class="btn btn-success btn-xs" href="actionAction.php?action=rel&rid=<?php echo $rid;?>&aid=<?php echo $v['aid'];?>">设为可用</a>
                                                            <?php }?>
