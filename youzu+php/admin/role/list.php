                                            ...
                                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="center">
                                                            <label>
                                                                <input type="checkbox" name="rid[]" value="<?php echo $v['rid'];?>" class="ace" />
                                                                <span class="lbl"></span>
                                                            </label>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs" href="menuSetting.php?id=<?php echo $v['rid'];?>">目录设置</a>
                                                            <a class="btn btn-success btn-xs" href="actionSetting.php?id=<?php echo $v['rid'];?>">权限设置</a>
                                                            <a class="btn btn-info btn-xs" href="edit.php?id=<?php echo $v['rid'];?>">编辑</a>
                                                            <a class="btn btn-danger btn-xs" href="del.php?id=<?php echo $v['rid'];?>">删除</a> 
                                                        </td>
                                                    </tr>
                                                    <?php }?>
