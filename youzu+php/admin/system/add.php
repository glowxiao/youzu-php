                                                            ...
                                                            <form class="form-horizontal" action="addAction.php" method="post">
							                                    <div class="form-group">
							                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">菜单名称</label>
							                                         <div class="col-sm-9">
							                                            <input type="text" name="title" id="form-field-1" placeholder="菜单名称" class="col-xs-10 col-sm-5" />
							                                        </div>
							                                    </div>
							                                    <div class="space-4"></div>
							                                     <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2">菜单链接</label>
                                                                     <div class="col-sm-9">
                                                                        <input type="text" name="url" id="form-field-2" placeholder="菜单链接" class="col-xs-10 col-sm-5" />
                                                                    </div>
                                                                </div>
                                                                <div class="space-4"></div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-3">菜单路径</label>
                                                                     <div class="col-sm-9">
                                                                        <input type="text" name="action" id="form-field-3" placeholder="菜单路径" class="col-xs-10 col-sm-5" />
                                                                    </div>
                                                                </div>
                                                                <div class="space-4"></div>
							                                     <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-4">菜单图标</label>
                                                                     <div class="col-sm-9">
                                                                        <input type="text" name="icon" id="form-field-4" placeholder="菜单图标" class="col-xs-10 col-sm-5" />
                                                                    </div>
                                                                </div>
                                                                <div class="space-4"></div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5">菜单排序</label>
                                                                     <div class="col-sm-9">
                                                                        <input type="text" name="sorts" id="form-field-5" placeholder="菜单名称" class="col-xs-10 col-sm-5" />
                                                                    </div>
                                                                </div>
                                                                <div class="space-4"></div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-select-1">菜单类型</label>
		                                                                <div class="col-sm-9">
			                                                            <select name="pid" class="col-xs-10 col-sm-5" id="form-field-select-1">
			                                                                <option value="0">顶级菜单</option>
			                                                                <?php foreach ($type as $v){?>
			                                                                <option value="<?php echo $v['mid'];?>"><?php echo $v['title'];?></option>
			                                                                <?php }?>
			                                                            </select>
		                                                            </div>
                                                                </div>
