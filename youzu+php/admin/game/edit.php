                                                ...
                                                <div class="widget-main padding-6">
                                                    <div class="tab-content">
                                                        <div id="home" class="tab-pane in active">
                                                            <form class="form-horizontal" action="editAction.php" method="post" enctype="multipart/form-data">
							                                    <div class="form-group">
							                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">游戏名称</label>
							                                         <div class="col-sm-9">
							                                            <input type="text" name="game_name" id="form-field-1" class="col-xs-10 col-sm-5" />
							                                        </div>
							                                    </div>
							                                    <div class="space-4"></div>
							                                     <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2">游戏类型</label>
                                                                     <div class="col-sm-9">
                                                                ...
                                                                <div class="space-4"></div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-3">游戏主图片</label>
                                                                     <div class="col-sm-9">
                                                                        <input type="file" name="img" id="form-field-3"  class="col-xs-10 col-sm-5" />
                                                                    </div>
                                                                </div>
                                                                <div class="space-4"></div>
							                                     <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-4">弹出图片</label>
                                                                     <div class="col-sm-9">
                                                                        <input type="file" name="tan_img" id="form-field-4" class="col-xs-10 col-sm-5" />
                                                                    </div>
                                                                </div>
                                                                <div class="space-4"></div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5">游戏图标</label>
                                                                     <div class="col-sm-9">
                                                                        <input type="file" name="icon_img" id="form-field-5" class="col-xs-10 col-sm-5" />
                                                                    </div>
                                                                </div>
                                                                <div class="space-4"></div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5">游戏描述</label>
                                                                     <div class="col-sm-9">
                                                                        <textarea rows="10" cols="20" name="game_content" id="form-field-5" class="col-xs-10 col-sm-5"> </textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="space-4"></div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-select-1">游戏类型1</label>
		                                                                <div class="col-sm-9">
			                                                            <select name="game_class" class="col-xs-10 col-sm-5" id="form-field-select-1">
