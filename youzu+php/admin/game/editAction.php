...
$sql = "UPDATE games SET game_name='{$game_name}',game_type='{$game_type}',img='{img}',tan_img='{$tan_img}',icon_img='{$icon_img}',game_content='{$game_content}',game_class='{$game_class}',update_time=$time;";
var_dump($sql);
