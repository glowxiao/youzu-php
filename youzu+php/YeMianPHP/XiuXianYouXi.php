...
$page_num = 4;
$count_sql = "SELECT COUNT(*) AS count_num from games where game_type='休闲游戏' AND status=1;";
...
$length = $page_num;
$sql6 = "SELECT * from games where game_type='休闲游戏' AND status=1 limit $start,$length";
...
<div class="main">
    ...
    <div class="main2">
        <div class="left" >
            ...
            <!-- 休闲游戏 -->
                 <div class="left2 xian" id="left2_2">
	...
	$.ajax({
		...
		success:function(e){
		    ...
		    if(e.status == 1){
		    	...
		    	$("#left2_2").append('<p>'+e.pageData.pageStr+'</p>');
			}
		}
	});
}
