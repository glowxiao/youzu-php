...
$page_num = 4;
$count_sql = "SELECT COUNT(*) AS count_num from games where game_type='手机游戏' AND status=1;";
...
$length = $page_num;
$sql6 = "SELECT * from games where game_type='手机游戏' AND status=1 limit $start,$length";
