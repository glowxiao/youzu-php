...
$page_num = 10;
$count_sql = "SELECT COUNT(*) AS count_num from news where news_type='活动新闻' AND status=1;";
...
$length = $page_num;
$sql6 = "SELECT * FROM news WHERE news_type='活动新闻' AND STATUS=1 limit $start,$length;";
