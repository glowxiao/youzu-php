    ...
    <div class="down1">
        <div class="left">
         ...
         <div class="right " id="zhanghao">
            <div class="one"><b>修改密码</b></div>
            <form action="pwdAction.php" method="post" id="pwd">
                <div><span>原始密码：</span><input type="password" name="ypwd"/></div>
                <div><span>新密码：</span><input type="password" name="xpwd"/></div>
                <div><span>确认新密码：</span><input type="password" name="qpwd"/></div>
